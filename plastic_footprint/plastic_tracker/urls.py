...
urlpatterns = [
    ...
    path('client/<id>/', views.client_info, name='client_info'),
    path('registerproduct/', views.product_registration, name='product_registration'),
    path('productlist/', views.product_list, name='product_list'),
    path('shoppinglist/', views.shopping_list, name='shopping_list'),
    path('shoppinglist/<id>', views.shopping_list, name='shopping_list'),
